...
type Asset = { id: string; storage_path: string; public_url: string | null; quality_score: number | null; emotion: string | null; scene: string | null; ai_summary: string | null; is_top_pick: boolean; analyzed: boolean; filename: string | null; kind: string; ai_score?: number | null; emotional_energy?: number | null; event_relevance?: number | null; people_engagement?: number | null; composition_quality?: number | null; storytelling_value?: number | null; brand_moment?: boolean | null; ai_scene_label?: string | null; ai_reject_reason?: string | null; scoring_method?: string | null };
type Metrics = { likes: number; shares: number; reach: number; comments: number };
type Post = { id: string; platform: string; format: string; caption: string; hashtags: string[] | null; image_url: string | null; storage_path?: string | null; audience?: string | null; best_time?: string | null; predicted_engagement?: number | null; metrics?: Metrics | null; engagement_score?: number | null; scene_description?: string | null; key_moment?: string | null; used_vision_ai?: boolean | null; source_asset_id?: string | null };
