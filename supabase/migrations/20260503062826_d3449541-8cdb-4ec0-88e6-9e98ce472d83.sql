...
create table public.events (
  ...
  status text not null default 'draft', -- draft | analyzing | generating | ready | failed
...
create table public.generated_posts (
  ...
  platform text not null, -- instagram | story | linkedin
...
create table public.agent_logs (
  ...
  event_id uuid not null references public.events(id) on delete cascade,
  user_id uuid not null references auth.users(id) on delete cascade,
  agent text not null, -- orchestrator | media | content | design | output
...
create policy "generated public read" on storage.objects for select using (bucket_id = 'generated');
